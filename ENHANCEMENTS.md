...
## Custom tag / metadata format

The default format for extra stuff like tags is [[This]]. But maybe users want something else like <(Tagname)> or others. Allow this to be set in preferences and saved locally. Also add a warning when none are found, and ask if the user has a different tag format.
